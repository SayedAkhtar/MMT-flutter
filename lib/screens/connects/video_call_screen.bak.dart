...
class Video_Call_Screen_Bak extends StatefulWidget {
  const Video_Call_Screen_Bak({super.key});

  @override
  State<Video_Call_Screen_Bak> createState() => _Video_Call_Screen_BakState();
}

class _Video_Call_Screen_BakState extends State<Video_Call_Screen_Bak> {
    ...
    if (_remoteUid.isNotEmpty) {
      ...
      return Text(
        _localUserJoined
            ...
            : "Click on the call button to connect call".tr,
